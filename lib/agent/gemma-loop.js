...
function buildPrompt(task, context) {
  ...
  // Build the existing articles list for SEE_ALSO (used at the end of the prompt)
...
TITLE: [2-5 words]
TYPE: [condition, phenomenon, place, object, event, person, species, legal-case, art-movement, machine, tradition, hoax, sport, recipe, disaster, organization, theory, material]
FIELD: [1-2 fields]
FIRST_DESCRIBED: [year]
KEY_RESEARCHERS: [2-3 names]

INTRO:
[1-2 paragraphs. Bold first sentence.]
...
SEE_ALSO: [pick 3-5 from: ${existingArticles.sort(() => Math.random() - 0.5).slice(0, 8).join(", ")}]
