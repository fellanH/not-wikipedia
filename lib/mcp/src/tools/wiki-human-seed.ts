...
export const tool: ToolModule = {
  definition: {
    ...
    description:
      "Fetch a random human-written text passage to serve as creative inspiration for new articles. Returns a quote or passage from literature, philosophy, or essays. Use this as a 'topic spark' - the themes and imagery can inspire Not-Wikipedia article topics.",
    inputSchema: {
      type: "object",
      properties: {
        use_fallback: {
          type: "boolean",
          description:
            "If true, skip external APIs and use only the embedded fallback corpus",
        },
      },
      required: [],
    },
